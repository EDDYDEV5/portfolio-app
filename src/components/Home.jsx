...
const Home = () => {
  ...
  return (
    <>
      <div
        name="home"
        className="h-fit w-full  pt-20 bg-gradient-to-tr bg-blue-950 to-"
      >
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-screen text-yellow-500 px-4 md:flex-row">
          <div className=" flex flex-col justify-center h-full ">
            ...
            <div>
              <div className=" cursor-pointer text-xl capitalize flex  rounded-md bg-yellow-500 justify-center items-center px-5 mt-2 w-40  hover:text- hover:bg-slate-100 py-3 delay-75 font-tektur text-blue-950">
                <ul>
